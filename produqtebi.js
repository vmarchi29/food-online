...
const RESTAURANTS = [
  ...
  extraDishes:{'დესერტი':['შოკოლადის ფონდანტი']} },
  ...
  { id:353, name:'ფრეშ გრილი', nameEn:'fresh grill', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ERqJgNvcPb2WDtsUA' },
  { id:354, name:'ოქროს ნალი', nameEn:'okros nali', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/rpL3DoNw3qyk8p9LA' },
  { id:355, name:'ფალას ქიჩენ', nameEn:'palace kitchen', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/y1urXSCjWCWkRDQS6' },
  { id:356, name:'დიოსკურია', nameEn:'dioskuria', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ghHv31W2cnZS3Hc18' },
  { id:357, name:'რესტორანი სამთავრო', nameEn:'restaurant samtavro', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/FoafCtND1UYJfD5s5' },
  { id:358, name:'ჭაშნაგირი', nameEn:'chashnagiri', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/rghzVXaeNFX3CSfc9' },
  { id:359, name:'ქვევრი', nameEn:'qvevri', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/MCkZvfr8MLagF3TQ6' },
  { id:360, name:'მწვადიაური', nameEn:'mtsvadiauri', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/GK7kxKtjtLD4Qoj18' },
  { id:361, name:'დალას პაბი', nameEn:'dallas pub', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/nZmjo4nAUXJzEAmTA' },
  { id:362, name:'რესტორანი კრუიზი', nameEn:'restaurant cruise', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ogmovhDt45jozCnCA' },
  { id:363, name:'მუხამბაზი', nameEn:'mukhambazi', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/Nr5gr5ykqtsWQBtj7' },
  { id:364, name:'ოქროს კათხა', nameEn:'golden mug', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/cSovCzbqEFKtu5YU8' },
  { id:365, name:'ასტროგრილი', nameEn:'astrogrill', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/967Miiz3fSwmuaM78' },
  { id:366, name:'ამარე', nameEn:'amare', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/SpHHyMWMd92QRVJY9' },
  { id:367, name:'ჰაკერ ფშორი', nameEn:'hacker pschorr', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/oqDrJaEzRdBbt4mr7' },
  { id:368, name:'მილანეზე ბისტრო', nameEn:'milaneze bisto', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ndiwrv6zYuAi9UcNA' },
  { id:369, name:'რესტორანი ქორნერის', nameEn:'corner restaurant', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/AfQnsNKymZomeQwE8' },
  { id:370, name:'ალხანაიძე', nameEn:'alkhanaidze', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/5XGwg9xPUFB4K4CG7' },
  { id:371, name:'voi cuisine', nameEn:'voi cuisine', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/7mj4fonozYLL56PF6' },
  { id:372, name:'დადიანი', nameEn:'dadiani', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/7bHryh7atsVWxxK3A' },
  { id:373, name:'ცეცხლი აინთო', nameEn:'tsetskhli ainto', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/H3xy7BjR3Kb9BQNF9' },
  { id:374, name:'ლაბაძის ძმის ქაბაბი', nameEn:'labadzis dzmis kababi', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/787ZM6hoeY4pyu7E8' },
  { id:375, name:'პაულანერის საძმო', nameEn:'paulaneris sadzmo', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/B47mNRPygsxqCV58A' },
  { id:376, name:'ბაბუს მწვადი', nameEn:'babus mtsvadi', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/iK3b9pNRyWXDWh5Q7' },
  { id:377, name:'la fiamma', nameEn:'la fiamma', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/AoLUjXiGeyoXTSfHA' },
  { id:378, name:'ზანო', nameEn:'zano', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/BkN34RZ79FK2ZLPY6' },
  { id:379, name:'სულთანი', nameEn:'sultan', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/FgF7pdf5tU7jBDhAA' },
  { id:380, name:'ჩიკაგო სთაილი', nameEn:'chikago style', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/be342gAtG3zbx5Cb8' },
  { id:381, name:'ზე ბეიქედ პოტეიტო', nameEn:'the baked potato', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/1HGhdSJGiFwzhkcB9' },
  { id:382, name:'ლულუ', nameEn:'lulu', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/2cGANPAoeAs4xDhj6' },
  { id:383, name:'ძაძიკი', nameEn:'tzatziki', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/pJKoT5Ag3MqcnP9j9' },
  { id:384, name:'ბადაგი', nameEn:'badagi', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/mzMSTkkPg2uHfBDT7' },
  { id:385, name:'ბელინი', nameEn:'belini', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ZdkH7DV22tsgmAaE6' },
  { id:386, name:'ჩანგალი', nameEn:'fork', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/bPEQTZnbTEp8cRmF9' },
  { id:387, name:'bacanos', nameEn:'bacanos', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/18tH2HTWAcr515me6' },
  { id:388, name:'artisan', nameEn:'artisan', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/kLZsxJrdvjWo1Bbp9' },
  { id:389, name:'salt', nameEn:'salt', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/vQ95Vk4NGrVNuvkX6' },
  { id:390, name:'კამპუსი', nameEn:'campus', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/vQ95Vk4NGrVNuvkX6' },
  { id:391, name:'ონო', nameEn:'ono', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/Y4sEffpraQzVta7N6' },
  { id:392, name:'tamtini', nameEn:'tamtini', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/iETxRW1iGvXcYYbi7' },
  { id:393, name:'მწვანე ტერასა', nameEn:'green terrace', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/WDAVv1J7F5RhAjKW9' },
  { id:394, name:'გრილ მორი', nameEn:'grill more', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/RQ1KemVNvvCgfo79A' },
  { id:395, name:'ბრავო', nameEn:'bravo', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/9ju7pZsoEUkxSnie7' },
  { id:396, name:'foodaholic', nameEn:'foodaholic', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/8gkFU7TARkh4pqKd6' },
  { id:397, name:'le marais', nameEn:'le marais', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/ifcdiZbpFNW3DxaG7' },
  { id:398, name:'AMÓS Restaurant', nameEn:'AMÓS Restaurant', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/RSeMD5L66CTEARcG8' },
  { id:399, name:'ბრუნო', nameEn:'bruno', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/uWtqQoxyUyoqVhBf9' },
  { id:400, name:'thekhachapuri', nameEn:'thekhachapuri', icon:'🥞', cuisine:'georgian', maps:'https://maps.app.goo.gl/v7ZpWqMh2AvM3eVx5' },
  ...
  { id:321, name:'ლევანის შაურმა', nameEn:'levanis shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/GtySskAZgBRxjNF3A' },
  { id:322, name:'kmc შაურმა', nameEn:'kmc shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/MWp39wDTeuH5AMmz9' },
  { id:323, name:'pm შაურმა', nameEn:'pm shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/gJfPthg91jDJS65Y8' },
  { id:324, name:'შაურმენი', nameEn:'shaurman', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/K2Smsz2LgJmTXb148' },
  { id:325, name:'მწვადის შაურმა', nameEn:'mtsvadis shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/J8mE14X8brausg6w8' },
  { id:326, name:'ჯანოს შაურმა', nameEn:'janos shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/kF2XQiuef3LGxKBV6' },
  { id:327, name:'დიდუბე შაურმა', nameEn:'didube shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/DLHYRQicUXJCvg296' },
  { id:328, name:'შაურმა ქორნერი', nameEn:'shaurma corner', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/XijHR3gdw1hYxRZKA' },
  { id:329, name:'ბუფეტი ნ1', nameEn:'green buffet n1', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/DwpQhAxkWc3puyye8' },
  { id:330, name:'სთრით ფუდი შაურმა ნაკვერჩხალზე', nameEn:'street food shawarma nakverchkhalze', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/VweWGbrFXHjco2yK6' },
  { id:331, name:'მაგემე შაურმა', nameEn:'mageme shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/7poJHCJPN2T4MoEXA' },
  { id:332, name:'შაურმა რა', nameEn:'shawarma ra', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/cb3GE4i1PGUwiVbFA' },
  { id:333, name:'დოქტორ შაურმა', nameEn:'doctor shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/mF13JR46gxsSKj9MA' },
  { id:334, name:'შაურმა დივო', nameEn:'shaurma divo', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/qJqcmFjjHLHFRHSUA' },
  { id:335, name:'ლაგუნას შაურმა ბროწეულით', nameEn:'lagunas shawarma brotseulit', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/9F2X2dBSFC1KDBXJ7' },
  { id:336, name:'შაურმა & დრაივი', nameEn:'shaurma & drive', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/KadodUfrtcZvQTDT7' },
  { id:337, name:'ჯანოს შაურმა', nameEn:'jano shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/UqsUiHpzTG9VYmxs5' },
  { id:338, name:'სანაპიროს შაურმა', nameEn:'sanapiros shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/k78dr3q9NzHfSMGZ9' },
  { id:339, name:'დელე შაურმა', nameEn:'dele shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/yABNQaLnF3dFmjHV7' },
  { id:340, name:'ალგეთის შაურმა', nameEn:'algetis shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/NcZbfqKWzRtnxcTSA' },
  { id:341, name:'მაქ შაურმა', nameEn:'maq shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/vb24uz5kmn9BCs4k9' },
  { id:342, name:'ქნოქ შაურმა', nameEn:'knock shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/eFadhDWYuxDABnmT6' },
  { id:343, name:'სიდას შაურმა', nameEn:'sidas shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/2j7VjHpC1WpntWWs6' },
  { id:344, name:'ფასთ შაურმა', nameEn:'fast shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/Uo4VbEyLWTx4drjx9' },
  { id:345, name:'შაურმა ნაკვერჩხალა', nameEn:'shawarma nakverchkhala', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/Um6vTTzZiPVHnvVz5' },
  { id:346, name:'bulls shaurma', nameEn:'bulls shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/EFZV2RMsbeo3Tn266' },
  { id:347, name:'პიტსტოპ შაურმა', nameEn:'pitstop shawarma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/4RgwECRJq36ZfEE5A' },
  { id:348, name:'ალფა შაურმა', nameEn:'alfa shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/3wVAX3kteqvUcYz1A' },
  { id:349, name:'რეზოს შაურმა', nameEn:'rezos shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/q6ZqoGQT1JZ34Cpw7' },
  { id:350, name:'საშაურმე Shaurma Jab&jek', nameEn:'Shaurma Jab&jek', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/iZwyH1B3EFZeuEwt8' },
  { id:351, name:'პო შაურმა & გრილი', nameEn:'pho shaurma & grill', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/GtiTyiZ1Sw6UnLmj7' },
  { id:352, name:'cool shaurma', nameEn:'cool shaurma', icon:'🥞', cuisine:'shawarma', maps:'https://maps.app.goo.gl/29QY6eSZoo6RhuNE9' },
